...
.image-animation {
  width: 1200px;
  height: 400px;
  /* background: url(admin/photos/pub1.jpg); */
...
@keyframes slideshow {
  0% {
    background-image: url(admin/photos/pub1.jpg);
  }
  14.5% {
    background-image: url(admin/photos/pub2.jpg);
  }
  29% {
    background-image: url(admin/photos/pub3.jpg);
  }
  43.5% {
    background-image: url(admin/photos/pub4.jpg);
  }
  58% {
    background-image: url(admin/photos/pub5.jpg);
  }
  73% {
    background-image: url(admin/photos/pub6.jpg);
  }
  100% {
    background-image: url(admin/photos/pub1.jpg);
  }
...
<div class="containerf">
    <div class="row">
      ...
      <img src="admin/photos/logo1.jpg" alt="">
    </div>
  </div>

...
<div>
<label>Id Client:</label><input type="number" name="id" placeholder="donner Id du client"><br>
<label>Téléphone</label><input type="number" name="numerotel" placeholder="donner le nouveau numero"><br>
</div>
<input type="submit" value="Modifier" size="50" class="submit"><br>
</form>
</body>
</html>
<?php
...
$client = new Client($_POST['id'],"","",0,"",$_POST['numerotel'],"","");

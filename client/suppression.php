...
<body>
<h3>Formulaire de Suppression d'un produit</h3>
<form Method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" >
<div>
<label> Id Client:</label><input type="number" name="id">
</div>
...
echo"<script>alert('cette personne n est pas inscrée ou déjà supprimée')</script>";
}
?>